classdef AlmostFinished < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createHomeScreen(app)
            ...
            % Light Mode Button
            lightModeButton = uibutton(app.HomeUI, 'push');
            lightModeButton.ButtonPushedFcn = @(~,~) switchToLightMode(app);
            lightModeButton.Position = [app.HomeUI.Position(3) - 100, app.HomeUI.Position(4) - 40, 30, 30]; % Top corner
            lightModeButton.Text = '☀️';
        
            % Dark Mode Button
            darkModeButton = uibutton(app.HomeUI, 'push');
            darkModeButton.ButtonPushedFcn = @(~,~) switchToDarkMode(app);
            darkModeButton.Position = [app.HomeUI.Position(3) - 60, app.HomeUI.Position(4) - 40, 30, 30]; % Top corner
            darkModeButton.Text = '🌑';
        ...
        function switchToLightMode(app)
            ...
            app.MusicPanel.BackgroundColor = app.LightBackgroundColor; % Update music panel color
            % Update other UI component colors here
        end
        
        function switchToDarkMode(app)
            app.HomeUI.Color = app.DarkBackgroundColor;
            app.MusicPanel.BackgroundColor = app.DarkBackgroundColor; % Update music panel color
        end
